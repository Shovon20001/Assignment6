    ...
    >
      ...
      <div className="flex items-center gap-3 md:gap-3">
        <Link
          ...
          className="inline-flex h-[34px] items-center rounded-full border border-[#374151] px-[18px] text-xs font-semibold text-white transition hover:border-accent hover:text-accent"
        >
          View Details
        </Link>
        {showDone && (
